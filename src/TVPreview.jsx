...
const PENCIL_PAGES = [
  ...
  { slug: "full-knowledge-page", label: "Knowledge Response Page Design", nodeId: "J66tW4" },
  ...
  { slug: "openclaw-ui-additions", label: "OpenClaw UI Additions (8 new cards)", nodeId: "aMgUJ" },
];
...
const LIVE_VIEWS = [
  ...
  { slug: "knowledge", label: "Knowledge Response", params: "?page=knowledge" },
