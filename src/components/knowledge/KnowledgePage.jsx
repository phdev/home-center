...
function MiddleCard({ knowledge, config }) {
  ...
  if (knowledge.type === "person") {
    return <TimelineCard timeline={knowledge.timeline} moduleStyle={moduleStyle} fallback={<AtAGlanceCard glance={knowledge.glance} type={knowledge.type} accent={config.accent} subjectTitle={knowledge.title} moduleStyle={knowledge.visualPlan.moduleStyles?.lower} />} />;
  }
...
function LowerCard({ knowledge, config }) {
  ...
  if (knowledge.type === "fauna" || knowledge.type === "flora") {
    return knowledge.glance.metrics.length
        ? <AtAGlanceCard glance={knowledge.glance} type={knowledge.type} accent={config.accent} subjectTitle={knowledge.title} moduleStyle={moduleStyle} />
        : <ProcessDiagramCard type={knowledge.type} glance={knowledge.glance} accent={config.accent} moduleStyle={moduleStyle} />;
  }
  return <AtAGlanceCard glance={knowledge.glance} type={knowledge.type} accent={config.accent} subjectTitle={knowledge.title} moduleStyle={moduleStyle} />;
}
