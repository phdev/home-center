...
function TopBar({ view, onViewChange, onBack, now, handControllerConnected, lastGesture }) {
...
function Sidebar({ today, events, monthGrid, view, birthdays }) {
  ...
  return (
    <div className="hc-dashboard-panel" style={{
      width: 350, flexShrink: 0, display: "flex", flexDirection: "column",
      gap: 24, overflow: "hidden", padding: 22,
    }}>
      {/* Date header */}
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 12, flex: 1, minHeight: 0, overflow: "auto" }}>
        ...
        {displayEvents.map((e, i) => {
          ...
          return (
            <div key={i} className="hc-dashboard-panel-item" style={{
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 8, flexShrink: 0 }}>
        ...
        {upcomingHolidays.map((h) => (
          <div key={h.date} className="hc-dashboard-panel-item" style={{
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 8, flexShrink: 0 }}>
        ...
        {upcomingBirthdays.map((b) => (
          <div key={b.id} className="hc-dashboard-panel-item" style={{
            display: "flex", alignItems: "center", gap: 10,
            padding: "8px 10px", borderRadius: 5,
            border: "1px solid #FFFFFF20",
          }}>
...
export function FullCalendarPage({ events, loading, view, onViewChange, onBack, handControllerConnected, lastGesture, birthdays }) {
  ...
  return (
    <div className="hc-full-page" style={{
      ...
      <TopBar view={view} onViewChange={onViewChange} onBack={onBack} now={now} handControllerConnected={handControllerConnected} lastGesture={lastGesture} />
      <div style={{
