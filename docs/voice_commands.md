...
Design Claw feedback is a local voice command:

- `Hey Homer, I like this`
- `Hey Homer, I like this design <notes>`
- `Hey Homer, I don't like this`
- `Hey Homer, I don't like this design <notes>`

The voice service records these through `scripts/record_design_feedback.py`,
